...
INITIAL_SALES_AMOUNT = int(os.environ.get("INITIAL_SALES_AMOUNT", "6000000000"))
# Daily: ₱1.64M daily sales (₱600M/year ÷ 365 days)
DAILY_SALES_AMOUNT = int(os.environ.get("DAILY_SALES_AMOUNT", "1644000"))
